...
| `getCollection`                       | Get data collection that refers to the specified collection path. When the response class is informed, the return data will be transformed to it.                                                                                                                               | `collection: string, options?: Options<T>, ResponseClass?: new () => R `                                                                                       | `Promise<R[]>`    |
| `getById<T>`                          | Get data from the collection by id.                                                                                                                                                                                                                                             | `collection: string, id: string `                                                                                                                              | `Promise<T>`      |
| `getByValue<R>`                       | Get data collection filtered by value. When the response class is informed, the return data will be transformed to it.                                                                                                                                                          | `collection: string, fieldPath: string, value: any, whereFilter?: WhereFilterOp, ResponseClass?: new () => R `                                                 | `Promise<R[]>`    |
