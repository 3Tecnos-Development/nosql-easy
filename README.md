...
| `removeElementInArray`         | Get data from a collection from the id and remove the specified element in an array field                                                                                                       | `collection: string, id: string, arrayFieldName: string, Value: any`                                                              | `Promise`         |
